...
class renta(models.Model):
     ...
     name = fields.Char(string = "DNI de la persona que realitza la renta: ", required = True) # DNI - String
     ...
     result = fields.Float(string = "Resultat del cálcul: ", default = 0, readonly = True) # resultat dels calculs
     
     @api.one
     def calcSalaryAnual(self):
		 self.result = self.salaryB * 14
		 #self.foo() # peta


	 #def foo(self):
	 #	 self.stateMarried = True
